...
<nav class="nav2">
	...
	try {
		...
		//if() {
			...
			rs = stmt.executeQuery("Select * from post where btype='면접게시판'");
		//}
...
<section class="center3">
	<div class="box">
	<a href="BulletinBoard4.jsp" class="btn-gradient blue mini">◁</a>
	<a href="BulletinBoard4.jsp" class="btn-gradient blue mini">1</a>
	<a href="BulletinBoard4.jsp" class="btn-gradient blue mini">▷</a>
	</div>
</section>
