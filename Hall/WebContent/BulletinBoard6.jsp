...
<nav class="nav2">
	...
	try {
		...
		//if() {
			...
			rs = stmt.executeQuery("Select * from post where btype='채용게시판'");
		//}
		...
		if(rs.next())	{
			do {
				...
				out.println("<tr>");
				out.println("<td height = '450' colspan = '8'>" + su + "</td>");
				out.println("</tr>");
...
<section class="center3">
	<div class="box">
	<a href="BulletinBoard6.jsp" class="btn-gradient blue mini">◁</a>
	<a href="BulletinBoard6.jsp" class="btn-gradient blue mini">1</a>
	<a href="BulletinBoard6.jsp" class="btn-gradient blue mini">▷</a>
	</div>
</section>
