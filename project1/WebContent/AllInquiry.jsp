...
%>
    ...
    <nav class="navbar">
      ...
      <ul class="navbar-menu">
           <li><a class="menubar" href="Gesipan.html">회원정보</a></li>
        <li><a class="menubar" href="AllInquiry.jsp">문의내역</a></li>
        <li><a class="menubar" href="Myroom.html">질문게시판</a></li>
        <li><a class="menubar" href="Myroom.html">면접게시판</a></li>
      </ul>
